...
const projects = [
  {
    title: "Suvalgyk Lithuania",
    description:
      "A recipe generation application in Lithuanian that uses OpenAI's GPT-3 to generate recipes based on user inputs.",
    image: "/Images/suvalgyk_lith.png",
    tags: ["Next.js", "TypeScript", "TailwindCSS", "FAST API", "PostgreSQL"],
    demoUrl: "https://www.suvalgyk.lt/",
    githubUrl: "#",
  ...
  },
  {
    title: "MakeAIR",
    description:
      "A full-stack web app for custom inflatable product design for a Italy based company",
    image: "/Images/makeaireal.png",
    tags: ["Next.js", "Server Actions", "PostgreSQL", "TailwindCSS"],
    demoUrl: "https://make-ai-real.vercel.app/",
    githubUrl: "#",
